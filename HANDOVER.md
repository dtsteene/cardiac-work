...
## Science and project state

Not duplicated here. The authoritative record is the knowledge base:

- **[docs/README.md](docs/README.md)** — what was run, what it showed, what is open
- **[docs/open-questions.md](docs/open-questions.md)** — read before quoting any septal number
- **[docs/provenance.md](docs/provenance.md)** — where data lives, and which raw data no longer exists
- **[docs/codebase-cleanup.md](docs/codebase-cleanup.md)** — what changed in the 2026-08-31 cleanup

For the pipeline itself see [WORKFLOW.md](WORKFLOW.md); for the repo map see
[README.md](README.md).
